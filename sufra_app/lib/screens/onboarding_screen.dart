...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  Future<void> _finish() async {
    ...
    await context.read<FamilyProvider>().setAll(_members);
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(fontSize: 16, color: SufraColors.muted(context), height: 1.6),
            textAlign: TextAlign.center,
          ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          Text(
            'من في أسرتك؟',
            style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: SufraColors.text(context)),
          ),
          const SizedBox(height: 6),
          Text(
            'أضف الاسم وأي حساسية غذائية. يمكنك التعديل في أي وقت لاحقًا.',
            style: TextStyle(fontSize: 14, color: SufraColors.muted(context)),
          ),
          ...
          Text('الحساسيات الشائعة (اختياري):', style: TextStyle(color: SufraColors.muted(context))),
