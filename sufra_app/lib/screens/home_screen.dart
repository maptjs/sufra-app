...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomAppBar(
        color: SufraColors.surface(context),
        ...
        child: Row(
          ...
          children: [
            ...
            _navButton(Icons.settings_rounded, 'الإعدادات', 3),
          ],
        ),
      ),
    );
  ...
  Widget _navButton(IconData icon, String label, int index) {
    ...
    final color = selected ? SufraColors.terracotta : SufraColors.muted(context);
    return InkWell(
      ...
      child: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text('سُفرة',
                        style: TextStyle(fontSize: 26, fontWeight: FontWeight.bold, color: SufraColors.text(context))),
                    Text('وجبات أسرتك، بثقة', style: TextStyle(fontSize: 13, color: SufraColors.muted(context))),
                  ],
                ),
                ClipRRect(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      ...
                      style: TextStyle(color: SufraColors.text(context), height: 1.5),
                    ),
                  ),
                ],
              ),
            ...
            const SizedBox(height: 28),
            Text('أحدث المسحات', style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700, color: SufraColors.text(context))),
            const SizedBox(height: 12),
            if (_recent.isEmpty)
              Padding(
                padding: const EdgeInsets.symmetric(vertical: 24),
                child: Text('لا توجد مسحات بعد — جرّب مسح أول منتج!', style: TextStyle(color: SufraColors.muted(context))),
              )
            else
              ..._recent.map((p) => Card(
                    child: ListTile(
